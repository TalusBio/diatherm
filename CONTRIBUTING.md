# Contributing to diatherm

First off, thank you for taking the time to contribute.

The following document provides guidelines for contributing to the
documentation and the code of diatherm. **No contribution is too small!** Even
...
3. The Code of Conduct, Release Notes, and this Contributing document are 
   markdown files that live in the root of the diatherm repository.
...
We welcome contributions to the source code of diatherm---particularly 
ones that address discussed [issues](https://github.com/TalusBio/diatherm/issues).

Contributions to diatherm follow a standard GitHub contribution workflow:

1. Create your own fork of the diatherm repository on GitHub.

2. Clone your forked diatherm repository to work on locally.
...
6. On the GitHub page for you forked repository, click "Pull request" to propose
   adding your changes to diatherm.

7. We'll review, discuss, and help you make any revisions that are required. If
   all goes well, your changes will be added to diatherm
   in the next release!


### Python code style

The diatherm project follows the [PEP 8
...
format code and lint Python code in diatherm.
...
2. Navigate to your local copy of the diatherm repository and activate the hook:
```bash
pre-commit install
```
